...
OS
  ...
  CentOS 4.7, CentOS 5.10, CentOS 6.4, Debian 7.1 で動作を確認しています。（ただし Debian 7.1 は Version 1.0.2 以前のバージョンでは動きません。詳細は :ref:`software_install_debian` をご覧ください）。
